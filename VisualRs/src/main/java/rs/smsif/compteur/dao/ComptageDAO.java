...
public class ComptageDAO extends DAO<Comptage> {
	...
	/**
	 * Méthode permettant de créer un objet Comptage
	 *
	...
	/**
	 * Méthode pour supprimer un élément de la base de donnée de type Comptage
	 *
	 ...
	 * @param medro
	 *            la colonne medro associée à la rubrique de solde
	 * @param rubriqueSolde
	 *            la rubrique de solde
	 * @return Comptage : trouve un élément unique de type Comptage
	 *
	 *
	 */

...
public class Comptage {
	 ...
	 * @param compteurBar
	 * @param compteurEvo
	 *            le nombre d'évolution.
	 * @param indic
	 *            un indicateur permettant de déterminer quelle RS est
	 *            développée dans une MEDRO donnée.
	 */
	public Comptage(String version, String medro, String rubriqueSolde, int compteurTot, int compteurBar,
			int compteurEvo, int indic) {
	...
	/**
	 * Surcharge de la méthode toString() pour l'objet Comptage
	 */
	@Override
	...
	/**
	 * Méthode retournant l'identifiant unique de l'objet Comptage
	 *
	 * @return String concaténation des différents champs constituant la clef
	 *         unique
	 */
	public String getId() {
